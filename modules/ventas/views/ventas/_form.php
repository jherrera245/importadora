                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <?= Html::activeLabel($model, 'id_orden', ['class' => 'control-label']) ?>
                            <?= $form->field($model, 'id_orden', ['showLabels' => false])->widget(Select2::class, [
                                'data' => ArrayHelper::map(Ordenes::find()->where(['estado' => 0, 'anulado'=> 0])->all(), 'id_orden', 'codigo'),
                                'language' => 'es',
                                'options' => ['placeholder' => 'Selecciona una orden de compra',],
                        ...
                        <div class="col-md-2 col-sm-12">
                            <?= Html::activeLabel($model, 'tipo_venta', ['class' => '¨form-label']) ?>
                            <?= $form->field($model, 'tipo_venta', ['showLabels'=>false])->radioList(
                                [
                                    0 => 'Contado',
                                    1 => 'Credito'
                                ],
